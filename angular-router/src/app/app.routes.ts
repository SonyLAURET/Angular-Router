...
export const ROUTES: Routes = [
    ...
    {path: PATH_DETAIL, component: DetailComponent,},
    {
        ...
        children: [
            ...
            { path: PATH_DETAIL_FORMATIONS, component: FormationsComponent ,resolve:{FormationsResolvers}},
            { path: PATH_DETAIL_CONNAISSANCES, component: ConnaissancesComponent, canActivate:[LoggedinGuard] }
        ],
